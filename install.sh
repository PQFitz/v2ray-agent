...
nginxBlog() {
    ...
    if [[ -d "${nginxStaticPath}" && -f "${nginxStaticPath}/check" ]]; then
        ...
        if [[ "${nginxBlogInstallStatus}" == "y" ]]; then
            ...
            if [[ "${release}" == "alpine" ]]; then
                wget -q -P "${nginxStaticPath}" "https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/fodder/blog/unable/html${randomNum}.zip"
            else
                wget -q "${wgetShowProgressStatus}" -P "${nginxStaticPath}" "https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/fodder/blog/unable/html${randomNum}.zip"
            fi
...
updateNginxBlog() {
    ...
    if [[ "${selectInstallNginxBlogType}" =~ ^[1-9]$ ]]; then
        ...
        if [[ "${release}" == "alpine" ]]; then
            wget -q -P "${nginxStaticPath}" "https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/fodder/blog/unable/html${selectInstallNginxBlogType}.zip"
        else
            wget -q "${wgetShowProgressStatus}" -P "${nginxStaticPath}" "https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/fodder/blog/unable/html${selectInstallNginxBlogType}.zip"
        fi
...
updateV2RayAgent() {
    ...
    if [[ "${release}" == "alpine" ]]; then
        wget -c -q -P /etc/v2ray-agent/ -N --no-check-certificate "https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/install.sh"
    else
        wget -c -q "${wgetShowProgressStatus}" -P /etc/v2ray-agent/ -N --no-check-certificate "https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/install.sh"
    fi
    ...
    echoContent skyBlue "wget -P /root -N --no-check-certificate https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/install.sh && chmod 700 /root/install.sh && /root/install.sh"
    echo
    exit 0
}
        ...
        if [[ -n $(ls /etc/v2ray-agent/subscribe_local/default/) ]]; then
            ...
            find /etc/v2ray-agent/subscribe_local/default/* | while read -r email; do
                ...
                if [[ -f "/etc/v2ray-agent/subscribe_local/sing-box/${email}" ]]; then
                    ...
                    if [[ "${release}" == "alpine" ]]; then
                        wget -O "/etc/v2ray-agent/subscribe/sing-box/${emailMd5}" -q "https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/documents/sing-box.json"
                    else
                        wget -O "/etc/v2ray-agent/subscribe/sing-box/${emailMd5}" -q "${wgetShowProgressStatus}" "https://gh.cdn.fullcone.cn/https://raw.githubusercontent.com/PQFitz/v2ray-agent/master/documents/sing-box.json"
                    fi
...
menu() {
    ...
    echoContent green "Github：https://gh.cdn.fullcone.cn/https://github.com/PQFitz/v2ray-agent"
